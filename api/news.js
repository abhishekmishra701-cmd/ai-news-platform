...
export default async function handler(req, res) {
  ...
  const base = id
    ...
    : "news_stories?status=in.(verified,published,corrected)&select=id,slug,headline,summary,body,category,country,country_code,region,status,verification_status,source_count,correction_notice,published_at,created_at,updated_at&order=published_at.desc.nullslast,created_at.desc";
