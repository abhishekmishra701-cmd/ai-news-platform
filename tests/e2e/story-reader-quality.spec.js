...
test.describe('Story Reader content quality', () => {
  ...
  test('publisher-reader fallback renders a multi-point brief when grounded service is insufficient', async ({ page }) => {
    ...
    await page.route('https://r.jina.ai/**', async route => {
      await route.fulfill({status:200,contentType:'text/plain',body:'# Iran says new sanctions threatened by desperate US will fail\n\nIran\'s foreign minister dismissed the threat of new US sanctions as a sign of desperation and said the measures would fail to defeat Tehran.\n\nThe United States has threatened to impose tougher sanctions on Iran.\n\nIran\'s economy is already under severe pressure from international sanctions and war damage.\n\nShipping through the Strait of Hormuz has been severely disrupted, affecting global oil prices.\n\nIranian officials called for respectful dialogue and a diplomatic solution.\n\nPakistan\'s army chief is expected to visit Tehran as part of regional mediation efforts.\n\nThe report also described continuing military and economic pressure on Iran.'});
    });
    await page.goto('/');
    await page.evaluate(() => {
